...
command_array = [help.TRIGGER, add_role.TRIGGER, remove_role.TRIGGER, lfg.TRIGGER, list_roles.TRIGGER, pizza.TRIGGER, weather.TRIGGER, raid.TRIGGER]

version = '2019-04-05_1'
